...
function AddCourse() {
  ...
  return (
    ...
    <div className=" px-4 sm:px-6 lg:px-8 py-10  bg-slate-700">
      <h2 className="text-3xl font-bold ml-[170px] text-center mb-9 text-white ">Added Course</h2>
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 ml-[170px]'>
          <div className="mb-4">
        ...
        <div className="flex justify-center">
          <button
            type="submit"
            className=" w-full ml-[170px] text-xl bg-blue-950 hover:bg-blue-900 text-white font-medium px-4 py-2 rounded-md"
          >
            Add Course
          </button>
        </div>
