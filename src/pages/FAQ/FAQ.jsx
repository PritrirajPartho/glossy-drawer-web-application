            ...
            <div className='text-center pt-16'>
                ...
                <div className="space-y-4">
                    <details className="w-full border rounded-lg">
                        <summary className="px-4 py-6 focus:outline-none focus-visible:ri">1.What is digital art, and how does it differ from traditional art?</summary>
                        <p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-400">Answer: Digital art is a form of visual art created using digital technology, such as computers, tablets, and specialized software. Unlike traditional art, which uses physical mediums like paint and canvas, digital art is created digitally using tools like digital brushes and pens on a digital canvas. </p>
                    </details>
                    <details className="w-full border rounded-lg">
                        <summary className="px-4 py-6 focus:outline-none focus-visible:ri">2.What hardware and software do I need to get started with digital art?</summary>
                        <p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-400">Answer: To start with digital art, you'll need a computer or tablet with sufficient processing power and memory, a stylus or digital pen, and graphics software designed for digital art creation. Popular software options include Adobe Photoshop, Corel Painter, Clip Studio Paint, and Procreate for tablets. </p>
                    </details>
                    <details className="w-full border rounded-lg">
                        <summary className="px-4 py-6 focus:outline-none focus-visible:ri">3.Is digital art as legitimate as traditional art?</summary>
                    ...
                    <details className="w-full border rounded-lg">
                        <summary className="px-4 py-6 focus:outline-none focus-visible:ri">4.How can I improve my digital art skills?</summary>
                        <p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-400">
